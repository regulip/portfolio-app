...
def get_portfolio_data():
    ...
    (Készségek, Projektek), hogy be tudja tölteni a weblapra görgetéskor.
    """
    # Ezt később kibővítjük a valós önéletrajzi adataiddal
    portfolio_content = {
        "introduction": "A Gábor Dénes Egyetem mérnökinformatikus hallgatójaként...",
        "projects": ["Okosotthon Vezérlőpult", "Mozis jegyfoglaló rendszer"],
        "skills": ["Python", "Flask", "JWT", "REST API", "SQL"]
    }
